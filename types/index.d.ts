declare module 'bn.js' {
  declare class BN {
    ...
    constructor(
      number: number | string | number[] | Uint8Array | Buffer | BN | null,
      base?: number | 'hex',
    ...
    /**
     * @description shift right (unimplemented https://github.com/indutny/bn.js/blob/master/lib/bn.js#L2090)
     */
    ishrn(b: number): BN
    ...
    /**
     * @description Check value whether is 1
     */
    isOne(): boolean
    /**
     * @description true if the number is negative
    ...
    isNegative(): boolean
    /**
     * @description add number n(defaults to 1)
     */
    iinc(n?: number): BN
    /**
     * @description subtract number n(defaults to 1)
     */
    idec(n?: number): BN
    imod(b: BN): BN
    iumod(b: BN): BN
    ...
    modExp(e: BN, n: BN)
    modInv(n: BN)
    ileftShift(x: number | BN)
    leftShift(x: number | BN)
    irightShift(x: number | BN)
    rightShift(x: number | BN)
    equal(x: BN)
    getBit(i: number): 0 | 1
    toUint8Array(endian?: 'be' | 'le', length?: number)
  }
